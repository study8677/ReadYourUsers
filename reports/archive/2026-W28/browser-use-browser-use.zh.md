...
- **数量:** 22 条 issue (13 未关闭, 9 已关闭)
- **需求得分:** 2.5
- **平均反应:** 0 | **平均评论:** 1.7
- **示例 Issue:** [#4580](https://github.com/browser-use/browser-use/issues/4580), [#4579](https://github.com/browser-use/browser-use/issues/4579), [#4571](https://github.com/browser-use/browser-use/issues/4571), [#4548](https://github.com/browser-use/browser-use/issues/4548), [#4538](https://github.com/browser-use/browser-use/issues/4538)
