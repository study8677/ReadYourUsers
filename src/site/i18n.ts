...
export const ui = {
  en: {
    ...
    homeProductViewDetail: "View details",
    ...
    printTitle: "User Demand Report",
    printGenerated: "Generated",
    printIssuesAnalyzed: "Issues analyzed",
    printClusters: "Need clusters",
    printIncluded: "included",
    printProductSnapshot: "Product Snapshot",
    printTopNeed: "Top need",
    printRisingNeed: "Rising need",
    printDominantCategory: "Dominant category",
    printTopNeeds: "Top Needs",
    printPoweredBy: "Powered by ReadYourUsers — Public issue intelligence",
  ...
  zh: {
    ...
    printTitle: "用户需求报告",
    printGenerated: "生成日期",
    printIssuesAnalyzed: "分析 Issue 数",
    printClusters: "需求簇",
    printIncluded: "纳入分析",
    printProductSnapshot: "产品快照",
    printTopNeed: "头号需求",
    printRisingNeed: "上升需求",
    printDominantCategory: "主导分类",
    printTopNeeds: "重点需求",
    printPoweredBy: "由 ReadYourUsers 生成 — 公开 Issue 情报",
    switchToEnglish: "English",
    switchToChinese: "中文",
